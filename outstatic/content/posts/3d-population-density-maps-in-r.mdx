...
> \[!tip\] You can find even more information about the Kontur Population Dataset itself [in this article](https://www.kontur.io/portfolio/population-dataset/).
...
> \[!tip\] The full code is available in [this repository](https://github.com/atakanzen/population-visualization).